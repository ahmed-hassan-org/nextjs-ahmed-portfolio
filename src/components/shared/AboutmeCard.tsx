    ...
    >
      ...
      <div className="md:col-span-1 md:order-2 sm:col-span-3 sm:order-1 sm:self-center sm:justify-self-center">
        <div className="img-section w-[320px] h-[360px] relative mt-5">
          <div className="relative bg-gray-200 w-[320px] h-[360px] z-10"></div>
          <Image
            src={pic2}
            alt="logo2"
      ...
      <div className="md:col-span-2 sm:col-span-3 sm:order-2 sm:mb-10 px-16">
        <h1 className="text-gray-900 text-2xl sm:text-lg font-semibold">
        ...
        <div className="w-full mt-5 grid grid-cols-2 gap-3">
          <div className="col-span-1">
            <ul className="flex flex-col">
              <li className="flex-1">
                <h4 className="text-base">Google fonts</h4>
              </li>
              <li className="flex-1">
                <h4 className="text-base">front end developer</h4>
              </li>
            </ul>
          </div>
          <div className="col-span-1">
